...
int sensorPin = 0; //pin analogico 0  delant izq
int varSensor = 0;
int sensorPin2 = 2; //pin analogico 2 izq
int varSensor2 = 0;
int sensorPin4 = 4; //pin analogico 4 decha
int varSensor4 = 0;
int sensorPin5 = 5; //pin analogico 5 delant dcha
int varSensor5 = 0;
...
void setup(){
  Serial.begin(9600);
    myservo.attach(3);  // izquierda
    myservo2.attach(5); // decha

 attachInterrupt(2, fan_interrupt, CHANGE);// pin 0 digital izquierda
  attachInterrupt(1, fan2_interrupt, CHANGE);// pin 2 digital derecha
...
/////////////AQUI SIGO
  ...
  if(varSensor < 40 && varSensor5 < 40){ //visualizando con el monitor serie se observa que el sensor detecta distancias superiores a 30cm, por ejemplo 40*5/1023=0.19V que equivale a x cm
      ...
      myservo.attach(3); 
      myservo2.attach(5);   
      pos = 75 ;           // movimiento "adelante" rapido
      myservo.write(pos);
      pos = 115; 
      myservo2.write(pos); 
      delay(2000);
...
gderecha:
        ...
        myservo.attach(3); 
        myservo2.attach(5);   
        pos = 115 ;           // movimiento "atras" rapido
        myservo.write(pos); // considero servo izquierda
        pos= 75;
        myservo2.write(pos); //considero servo derecha
